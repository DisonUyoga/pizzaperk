...
export async function nativeNotify(message: string) {
  const URL =
    "https://cdn.pixabay.com/photo/2016/03/05/09/22/eat-1237432_960_720.png";
...
export async function notifyUserAboutOrder(
  ...
  switch (status) {
    ...
    case "DELIVERED":
      message =
        "Your order has been delivered successfully. We are grad to serve you!!!";
      break;
    default:
  ...
  sendPushNotification(
    token as unknown as Notifications.ExpoPushToken,
    "PizzaPerk",
    message
  );
}
