...
CREATE POLICY "allow only authenicated users" ON "public"."products" TO "authenticated" USING (true);

CREATE POLICY "order" ON "public"."orders" TO "authenticated" USING (true);

CREATE POLICY "order items updated" ON "public"."order_items" TO "authenticated" USING (true);
